...
We could go with a couple of options:
1) Stream graph of size/cost of wheels over time
2) Bivariate scale map but just focussing on the countries where we have data and using metrics other than cost.
...
ggplot() +
  ...
  theme(legend.position = "none",
        ...
        plot.title = element_markdown(family = "Alfa_Slab_One", size = 18,
                                      colour = "#1a1110"),
