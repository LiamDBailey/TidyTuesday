...
final_map <- ggplot() +
  ...
  labs(title = "Where's Bigfoot?",
       subtitle = stringr::str_replace_all(stringr::str_wrap(string = "There have been over 4,000 geolocated sightings of bigfoot in the lower 48 states of the US, but what type of habitat is bigfoot most likely to occur in? In this map we estimate the probability to observe bigfoot based on the local temperature and rainfall (worldclim.org), elevation (srtm.csi.cgiar.org), and tree cover (esa-worldcover.org). We predict bigfoot sightings to be more likely in forested areas along the East and West coast of the US, while sightings across the Great Plains and within the Everglades are much less likely.", width = 90), pattern = "\n", replacement = "<br>"),
