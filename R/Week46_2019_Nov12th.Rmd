...
current_theme <- theme_classic() +
  theme(legend.position = c(0.65, 0.35),
        ...
        legend.text = element_text(family = "Courier New", size = 10),
        legend.title = element_text(family = "Courier New", size = 15),
        legend.text.align = 0,
        legend.spacing.x = unit(x = 0.25, units = "cm"),
        axis.line = element_blank(),
        axis.ticks = element_blank(),
        axis.text = element_text(colour = "black", family = "Courier New", size = 10),
        axis.title = element_text(colour = "black", family = "Courier New", size = 20),
...
curve_data <- dplyr::bind_rows(hi_impact, hi_dlds)
...
ggplot(code_impact) +
  ...
  geom_curve(data = curve_data,
             aes(xend = total_lines, yend = downloads, x = total_lines + 15000, y = downloads - 5000000),
             arrow = arrow(length = unit(0.1, units = "inches")), curvature = 0.1) +
  geom_text(data = curve_data,
            aes(x = total_lines + 20000, y = downloads - 6000000, label = stringr::str_wrap(text, 30)),
...
ggplot2::ggsave(filename = "../plots/Week46.png", height = 10, width = 12, dpi = 600, type = "cairo")
